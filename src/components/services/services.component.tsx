    ...
    <div id='services' className="flex flex-col items-center bg-primary-gray text-white py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl">
        <div className="flex flex-col items-center rounded-lg px-8 py-10">
          ...
          <h3 className="text-2xl uppercase font-normal mb-3 text-center">New Build/Custom Homes</h3>
        ...
        <div className="flex flex-col items-center rounded-lg px-8 py-10">
          ...
          <h3 className="text-2xl uppercase font-normal mb-3 text-center">Renovations</h3>
        ...
        <div className="flex flex-col items-center rounded-lg px-8 py-10">
          ...
          <h3 className="text-2xl uppercase font-normal mb-3 text-center">Repairs and Restorations</h3>
