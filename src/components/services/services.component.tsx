    ...
    <div id='services' className="flex flex-col items-center min-h-[50vh] bg-primary-gray text-white py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl">
        <div className="flex flex-col items-center rounded-lg px-8 py-10">
          <img src="https://via.placeholder.com/150" className='rounded-sm my-5' alt="renovations" width={150} height={150} />
        ...
        <div className="flex flex-col items-center rounded-lg px-8 py-10">
          <img src="https://via.placeholder.com/150" className='rounded-sm my-5' alt="repairs" width={150} height={150} />
